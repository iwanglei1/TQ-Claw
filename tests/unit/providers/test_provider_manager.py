...
import tqclaw.providers.provider_manager as provider_manager_module
...
from tqclaw.providers.provider import DefaultProvider, ModelInfo
from tqclaw.providers.provider_manager import ProviderManager
...
def isolated_secret_dir(monkeypatch, tmp_path):
    secret_dir = tmp_path / ".tqclaw.secret"

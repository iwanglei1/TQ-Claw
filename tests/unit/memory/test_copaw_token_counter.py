# -*- coding: utf-8 -*-
"""Unit tests for TqclawTokenCounter.
...
from tqclaw.agents.utils.tqclaw_token_counter import (
    TqclawTokenCounter,
    _get_tqclaw_token_counter,
)
import tqclaw.agents.utils.tqclaw_token_counter as token_counter_module
...
def test_cache_returns_same_instance_for_same_config() -> None:
    ...
    counter1 = _get_tqclaw_token_counter(mock_config)
    counter2 = _get_tqclaw_token_counter(mock_config)
...
def test_different_config_creates_new_instance() -> None:
    ...
    counter1 = _get_tqclaw_token_counter(mock_config1)
    counter2 = _get_tqclaw_token_counter(mock_config2)
...
def run_all_tests() -> None:
    ...
    print("=" * 60)
    print("Running TqclawTokenCounter tests")
    print("=" * 60)

# -*- coding: utf-8 -*-
"""Tool-guard mixin for TQClawAgent.
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from tqclaw.security.tool_guard.engine import get_guard_engine
        from tqclaw.app.approvals import get_approval_service
            ...
            if tool_name and engine.enabled:
                ...
                if engine.is_guarded(tool_name):
                    ...
                    if result is not None and result.findings:
                        from tqclaw.security.tool_guard.utils import (
                            log_findings,
                        )
    ...
    async def _acting_auto_denied(
        ...
        from tqclaw.security.tool_guard.approval import (

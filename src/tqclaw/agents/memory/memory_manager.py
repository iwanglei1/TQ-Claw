...
"""Memory Manager for TQ-Claw agents.
...
from tqclaw.agents.model_factory import create_model_and_formatter
from tqclaw.agents.tools import read_file, write_file, edit_file
from tqclaw.agents.utils import _get_tqclaw_token_counter
...
class MemoryManager(ReMeLight):
    """Memory manager that extends ReMeLight for TQ-Claw agents.
    ...
    def __init__(
        ...
        # Initialize parent ReMeTqclaw class
        super().__init__(
        ...
        self.token_counter = _get_tqclaw_token_counter(agent_config)

...
_USE_SYNC_PLAYWRIGHT = (
    sys.platform == "win32" and os.environ.get("TQCLAW_RELOAD_MODE") == "1"
)
...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs TQ-Claw (e.g. "

...
variable ``TQCLAW_AUTH_ENABLED`` is set to a truthy value (``true``,
...
def is_auth_enabled() -> bool:
    ...
    Returns ``True`` when ``TQCLAW_AUTH_ENABLED`` is set to a truthy
    ...
    """
    env_flag = os.environ.get("TQCLAW_AUTH_ENABLED", "").strip().lower()

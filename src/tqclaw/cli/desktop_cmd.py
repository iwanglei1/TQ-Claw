# -*- coding: utf-8 -*-
"""CLI command: run TQ-Claw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run TQ-Claw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing TQ-Claw app instance.
    """
    ...
    click.echo(f"Starting TQ-Claw app on {url} (port {port})")

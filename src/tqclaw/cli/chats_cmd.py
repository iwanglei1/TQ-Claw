...
def chats_group() -> None:
    ...
    \b
    Common examples:
      tqclaw chats list                    # List all chats
      tqclaw chats list --user-id alice    # Filter by user
      tqclaw chats get <chat_id>           # View details
      tqclaw chats create --session-id s1 --user-id u1
      tqclaw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      tqclaw chats list
      tqclaw chats list --user-id alice
      tqclaw chats list --channel discord
      tqclaw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `tqclaw chats list`.
...
def create_chat(
    ...
    Inline creation examples:
      tqclaw chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      tqclaw chats create -f chat.json
    """
    base_url = _base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      tqclaw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
    headers = {"X-Agent-Id": agent_id}
...
def delete_chat(
    ...
    \b
    Examples:
      tqclaw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
        headers = {"X-Agent-Id": agent_id}

...
Configuration via environment variables (or use defaults from constant.py):
    TQCLAW_LLM_MAX_RETRIES   – max retry attempts (default 3)
    TQCLAW_LLM_BACKOFF_BASE  – base delay in seconds (default 1.0)
    TQCLAW_LLM_BACKOFF_CAP   – max delay cap in seconds (default 10.0)
"""

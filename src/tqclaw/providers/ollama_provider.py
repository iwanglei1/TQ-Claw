...
from tqclaw.providers.provider import ModelInfo, Provider
    ...
    def _client(self, timeout: float = 5):
        if ollama is None:
            raise ImportError(
                ...
                "also need the Python SDK to manage models from TQ-Claw. "
                "Please install it with: pip install 'tqclaw[ollama]'",
            )

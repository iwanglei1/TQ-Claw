...
**MCP (Model Context Protocol)** allows TQ-Claw to connect to external MCP servers and use their tools. You can add MCP clients through the Console to extend TQ-Claw's capabilities.
...
TQ-Claw supports three JSON formats for importing MCP clients:

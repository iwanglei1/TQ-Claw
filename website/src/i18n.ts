...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "usecases.creative.1":
      "睡前向 TQ-Claw 说明目标并设定自动执行，次日即可获得可用的雏形。",
    "usecases.creative.2":
      "从选题、找素材到确定方向，TQ-Claw 可协助完成视频内容创作全流程。",
    ...
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使用 TQ-Claw。",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest TQ-Claw updates",
    "follow.xiaohongshu": "Rednote:",
    "follow.x": "X:",
    "brandstory.title": "Why TQ-Claw?",
    "brandstory.para1":
      'TQ-Claw represents both a Co Personal Agent Workstation and a "co-paw"—a partner always by your side.',
    "brandstory.para2":
      'More than just a cold tool, TQ-Claw is a warm "little paw" always ready to lend a hand (or a paw!). It is the ultimate teammate for your digital life.',
    ...
    "usecases.title": "What you can do with TQ-Claw",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to TQ-Claw and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, TQ-Claw supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; TQ-Claw analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install → init → start. Configure channels to use TQ-Claw on DingTalk, Feishu, QQ, etc. See ",
    ...
    "quickstart.badgeBeta": "Beta",
    footer: "TQ-Claw — Works for you, grows with you",

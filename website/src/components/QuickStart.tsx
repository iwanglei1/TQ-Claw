...
const DOCKER_IMAGE = "agentscope/tqclaw:latest";
const MODELSCOPE_URL =
  "https://modelscope.cn/studios/fork?target=AgentScope/TQ-Claw";
...
const DESKTOP_RELEASES_URL = "https://github.com/agentscope-ai/TQ-Claw/releases";

const COMMANDS = {
  pip: ["pip install tqclaw", "tqclaw init --defaults", "tqclaw app"],
  scriptMac: [
  ...
  docker: [
    ...
    `docker run -p 127.0.0.1:8088:8088 -v tqclaw-data:/app/working -v tqclaw-secrets:/app/working.secret ${DOCKER_IMAGE}`,
  ],
} as const;

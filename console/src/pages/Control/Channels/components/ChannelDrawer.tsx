...
// Doc EN URLs per channel (anchors on https://tqclaw.agentscope.io/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://tqclaw.agentscope.io/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://tqclaw.agentscope.io/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://tqclaw.agentscope.io/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://tqclaw.agentscope.io/docs/channels/?lang=en#Discord",
  qq: "https://tqclaw.agentscope.io/docs/channels/?lang=en#QQ",
  telegram: "https://tqclaw.agentscope.io/docs/channels/?lang=en#Telegram",
...
// Doc ZH URLs per channel (anchors on https://tqclaw.agentscope.io/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#飞书",
  imessage:
    "https://tqclaw.agentscope.io/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#Discord",
  qq: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#QQ",
  telegram: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#Telegram",
  mqtt: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#MQTT",
  mattermost: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#Mattermost",
  matrix: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#Matrix",
  wecom: "https://tqclaw.agentscope.io/docs/channels/?lang=zh#企业微信",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
};
        ...
        return (
          <>
            ...
            <Form.Item name="media_dir" label="Media Dir">
              <Input placeholder="~/.tqclaw/media" />
            </Form.Item>
          </>
        );
      ...
      case "mattermost":
        return (
          <>
            ...
            <Form.Item name="media_dir" label="Media Dir">
              <Input placeholder="~/.tqclaw/media/mattermost" />
            </Form.Item>
            <Form.Item
              name="show_typing"
              label="Show Typing"
          ...
          <Button
            ...
            onClick={() => {
              const url =
                CHANNEL_DOC_EN_URLS[activeKey]! ||
                CHANNEL_DOC_ZH_URLS[activeKey]!;
              const isTqclawDoc = url.includes(
                "tqclaw.agentscope.io/docs/channels/",
              );
              const finalUrl =
                isTqclawDoc && currentLang === "zh"
                  ? CHANNEL_DOC_ZH_URLS[activeKey]!
                  : CHANNEL_DOC_EN_URLS[activeKey]!;

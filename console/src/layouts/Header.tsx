...
// Constants
const GITHUB_URL = "https://github.com/agentscope-ai/TQ-Claw" as const;
...
const getDocsUrl = (lang: string): string =>
  `https://tqclaw.agentscope.io/docs/intro?lang=${getWebsiteLang(lang)}`;

const getFaqUrl = (lang: string): string =>
  `https://tqclaw.agentscope.io/docs/faq?lang=${getWebsiteLang(lang)}`;

const getReleaseNotesUrl = (lang: string): string =>
  `https://tqclaw.agentscope.io/release-notes?lang=${getWebsiteLang(lang)}`;
